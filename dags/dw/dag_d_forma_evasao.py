...
class DFormaEvasaoFactory(_BaseOperatorFactory):
    def __init__(
        self, 
        conn_input:str, 
        conn_output:str,
        ...
        self._table_name= 'd_forma_evasao'
    ...
    def prepare_callable(self):
        ...
        self._sk_column = 'sk_forma_evasao'
        self._dtypes = {'ds_forma_evasao': 'string'}
        query = """
            select distinct ds_forma_evasao from stg.v_ds_stg_relatorio
            except
            select ds_forma_evasao from dw.d_forma_evasao
        """
...
# factory = DFormaEvasaoFactory('conn_dbdw', 'conn_dbdw')
